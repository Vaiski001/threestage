...
import { MessageSquare, Users, BarChart, Settings, Bell, Search, Sun, User } from "lucide-react";
            ...
            <div className="pt-8 pb-4 px-4 sm:px-6">
              <Container size="full">
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-8">
                  <div>
                    <h1 className="text-2xl font-semibold mb-1">Demo Dashboard</h1>
                    <p className="text-muted-foreground">This is a demonstration of the enquiry management system.</p>
                  </div>
