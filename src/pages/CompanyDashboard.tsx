...
import { Filter, Plus, Search, Bell, PlusCircle, BarChart2 } from "lucide-react";
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
              ...
              <TabsContent value="analytics">
                <div className="bg-card rounded-lg border shadow-sm p-8 text-center">
                  ...
                  <p className="text-muted-foreground max-w-md mx-auto mb-6">
                    Track performance, monitor trends, and gain insights into your business operations.
                  </p>
                  <Button onClick={() => toast({ title: "Feature coming soon", description: "Full analytics functionality is coming soon." })}>
                    Explore Analytics
                  </Button>
                </div>
              </TabsContent>
